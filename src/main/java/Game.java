class Game {
   ...
   *
   * @param scores an array of int used for the getScore of the
   */
  Game(int[] scores) {
    rolls = scores;
  }
  ...
  /**
   * Loops through the number of frames in a line and calculates the getScore of the game
   *
   * @return an int representing the getScore of the game
   */
  public int getScore() {
    int score = 0;
    int frameIndex = 0;
